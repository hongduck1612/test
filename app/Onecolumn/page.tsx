...
import Username from "../public/image/arrow.png";
import user3 from "../public/image/testimonial-image1.png";
import user4 from "../public/image/service-icon3.png";
...
export default function FourColumn() {
  ...
  <div className="relative h-[600px]">
    <Image
      src={blog2} // Assuming blog1 is defined elsewhere
      alt="Profile picture of a woman with glasses"
      layout="fill"
      objectFit="cover"
      className="w-full h-full object-cover"
  ...
  <div className="relative h-[600px]">
    <Image
      src={blog3} // Assuming blog1 is defined elsewhere
      alt="Profile picture of a woman with glasses"
      layout="fill"
      objectFit="cover"
      className="w-full h-full object-cover"
